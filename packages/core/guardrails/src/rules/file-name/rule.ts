...
import type { StructureFileNameRuleConfig } from '../../types';
 ...
 */
export class Rule extends StructureRule<string | StructureFileNameRuleConfig> {
  public readonly key = 'fileName';

  protected evaluateNode(node: TraversalNode, value: string | StructureFileNameRuleConfig) {
