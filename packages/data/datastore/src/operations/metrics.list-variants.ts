...
export function metricsListVariantsOperation(ctx: DatastoreContext) {
  return async function handler(input: OperationHandlerInput): Promise<{ items: MetricVariant[] }> {
    const parseDimensions = (raw: MetricDimensionSource): MetricDimensionsRecord => {
