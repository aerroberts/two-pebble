...
import type { StackedTimelineBarChartSeries } from './types';

interface StackedTimelineLegendProps {
...
export function StackedTimelineLegend(props: StackedTimelineLegendProps) {
  return (
