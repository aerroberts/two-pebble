...
describe('feature: react-jsx-style rule', () => {
  ...
  test('unhappy: reports focused violation', async () => {
    ...
    expect(errors).toContain('react-classname-or-style');
  });
});
