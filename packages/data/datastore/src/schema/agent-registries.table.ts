...
/**
 * An agent registry row is a user-configured agent template. Registries are
 * global; projects choose which ones to expose via
 * `projects.enabled_agent_registry_ids`.
