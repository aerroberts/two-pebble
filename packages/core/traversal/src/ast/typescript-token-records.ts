...
export function createTokenRecord(records: TraversalNodeRecord[], input: TraversalTokenNodeInput) {
...
export function leadingCommentRecords(sourceFile: ts.SourceFile, node: ts.Node, records: TraversalNodeRecord[]) {
